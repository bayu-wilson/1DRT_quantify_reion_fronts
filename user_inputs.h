...
namespace user_inputs
{
  ...
  inline constexpr double R        { R0+1000 };  //Total radius for the spatial grid (in pkpc)
  ...
  inline constexpr double alpha { 1.505 }; //spectral power law index if spectrum is a power law
